...
#define PANTECH_AUDIO_AMP_GAIN			_IOW(PANTECH_AUDIO_IOCTL_MAGIC, 3, unsigned) //subamp gain control
#define PANTECH_AUDIO_AMP_MODE			_IOW(PANTECH_AUDIO_IOCTL_MAGIC, 4, unsigned) //subamp mode info control
#define PANTECH_AUDIO_AMP_BE_SET			_IOW(PANTECH_AUDIO_IOCTL_MAGIC, 5, unsigned) //subamp BE control
#define PANTECH_AUDIO_AMP_LOUD_SET		_IOW(PANTECH_AUDIO_IOCTL_MAGIC, 6, unsigned) //subamp LOUD control
#define PANTECH_AUDIO_GET_AMP_GAIN 		_IOR(PANTECH_AUDIO_IOCTL_MAGIC, 7, unsigned) // subamp gain control read
